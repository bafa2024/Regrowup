    ...
    $router->get('/', function () {
        echo '<h1>bramus/router</h1>
              ...
              <ul>
                ...
                <li><a href="/lab/'.date('Y').'">/lab/<em>year</em></a></li>
                <li><a href="/lab/'.date('Y').'/'.date('m').'">/lab/<em>year</em>/<em>month</em></a></li>
                <li><a href="/lab/'.date('Y').'/'.date('m').'/'.date('d').'">/lab/<em>year</em>/<em>month</em>/<em>day</em></a></li>
