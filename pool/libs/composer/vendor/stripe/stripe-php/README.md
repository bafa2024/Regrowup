...
Stripe's API now requires that [all connections use TLS 1.2](https://stripe.com/lab/upgrading-tls). Some systems (most notably some older CentOS and RHEL versions) are capable of using TLS 1.2 but will use TLS 1.0 or 1.1 by default. In this case, you'd get an `invalid_request_error` with the following error message: "Stripe no longer supports API requests made with TLS 1.0. Please initiate HTTPS connections with TLS 1.2 or later. You can learn more about this at [https://stripe.com/lab/upgrading-tls](https://stripe.com/lab/upgrading-tls).".
...
```bash
./pool/libs/composer/vendor/bin/phpunit tests/Stripe/UtilTest.php
```
...
```bash
./pool/libs/composer/vendor/bin/php-cs-fixer fix -v .
```
