 ...
 * @property string $method The method used to send this payout, which can be <code>standard</code> or <code>instant</code>. <code>instant</code> is only supported for payouts to debit cards. (See <a href="https://stripe.com/lab/instant-payouts-for-marketplaces">Instant payouts for marketplaces</a> for more information.)
