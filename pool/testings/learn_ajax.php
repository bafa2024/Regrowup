...
<body>
    ...
    <div class="container mt-2">
            ...
            <div class="col-md-6 ">
                ...
                <form action="" method="post" id="searchForm">
                        <div class="input-group">
                            <input type="text" class="form-control" name="query" id="queryInput" placeholder="Enter your query" style="width:500px;">
        ...
        <div class="row mt-1">
            <div class="col-md-6">
                <div class="content" id="answerDiv"></div>
            </div>
            <div class="col-md-6">
                <div class="contentImage" id="imageDiv"></div>
            </div>
        </div>
 ...
 <script>
        ...
        searchForm.addEventListener("submit", function (e) {
            ...
            fetch('/teach_api', {
                ...
                .then((data) => {
                    // Update the answer and image content
                    answerDiv.innerHTML = data.answer;
                    imageDiv.innerHTML = `<img src="${data.imgurl}" style="width:100%; height:630px; object-fit:contain;" />`;
                })
                .catch((error) => {
                    console.error(error);
                });
