            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="demo-form" action="/api/logsAPI.php" class="needs-validation" novalidate>
                            <input type="hidden" name="_token" value="6LdLfmwlAAAAAPBGLTdw8NAEKrb5IYZP7R28DgcW">
                            <div class="mb-3">
