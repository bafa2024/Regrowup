    ...
    ?>
        ...
        <div class="container-lg">
            <div class="row gy-4">
                ...
                $search=$contract->url_var('search');
                $country=$contract->url_var('country');
                $price=$contract->url_var('price');

                if($search || $country || $price){
               //write a array
                ...
                $contract->filter_contracts($search_query);
