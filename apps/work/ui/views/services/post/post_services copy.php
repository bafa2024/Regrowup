                        ...
                        <input type="hidden" name="service_status" value="1">                       
                         <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="row gy-3">
                                    <div class="col-12">
                                        <label for="" class="mytext-black fs-14 text-uppercase">Choose Your Category:
                                            <span class="fs-16 fw-900 text-danger">*</span></label>
                                    </div>
                                    <input type="hidden" name="jobstatus" id="jobstatus" value="1">
                                    <div class="col-md-6">
                                        <select required name="category" onchange="return getsubcategory(this)" id=""
                                    ...
                                    <div class="col-md-6 addsubcat">
                                        <select required name="subcategory" id=""
                                            class="bg-white w-100 border border-seacondary border-opcity-25 p-2 fs-14 rounded-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-2">
                                            <label for="" class="mytext-black fs-14 text-uppercase">Select location:
                                                <span class="fs-16 fw-900 text-danger">*</span></label>
                                            <select name="location" required id=""
                                                class="bg-white w-100 border border-seacondary border-opcity-25 p-2 fs-14 rounded-2">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-2">
                                            <label for="" class="mytext-black fs-14 text-uppercase">Select job type:
                                                <span class="fs-16 fw-900 text-danger">*</span></label>
                                            <select name="job_type" id="" required
                                                class="bg-white w-100 border border-seacondary border-opcity-25 p-2 fs-14 rounded-2">
                                                <option value="">Select Job Type</option>
                                                <option value="3 month">Short-term(up to 3 months)</option>
                                                <option value="3 month+">Medum-term(up to 3 months+)</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-2">
                                            <label for="" class="mytext-black fs-14 text-uppercase">Available Days:
                                                <span class="fs-16 fw-900 text-danger">*</span></label>
                                            <select name="availabledays" id="" required
                                                class="bg-white w-100 border border-seacondary border-opcity-25 p-2 fs-14 rounded-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-2">
                                            <label for="" class="mytext-black fs-14 text-uppercase">Service Option:
                                                <span class="fs-16 fw-900 text-danger">*</span></label>
                                            <select name="serviceoption"
                                                class="bg-white w-100 border border-seacondary border-opcity-25 p-2 fs-14 rounded-2"
                                                required>
                                                <option value="">--Select--</option>
                                                                                                                                                <option value="Industy">Industy</option>
                                    ...
                                    <div class="col-12 step2">
                                        <div class="d-flex flex-column gap-2">
                                            <label for="" class="mytext-black fs-14 text-uppercase">create
                                                FAQ</label>
                                            <!-- loop -->
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-justify-center">
                                    <button type="submit" class="post-btn mx-auto" name="local_service">
                                        Post a job
                                    </button>
                                </div>
                            </div>
...
<script>
function posttextclick(id) {
    if (id == 1) {
        $('#jobstatus').val('2');
        $('.uprtext').html('YOUR Student JOBS');
        $('.textedit').html('Post Contract jobs for full or part time workers');
        $('.posttextclick').html('Contract Jobs');
        $('.changeoncl').attr("onclick", "posttextclick('2')");
    }
    if (id == 2) {
        $('#jobstatus').val('2');
        $('.uprtext').html('YOUR CONTRACT JOBS');
        $('.textedit').html('Post small jobs primarily targeted at students');
        $('.posttextclick').html('Student Jobs');
        $('.changeoncl').attr("onclick", "posttextclick('1')");
    }
}
...
function getsubcategory(_this) {
    ...
    if (vl != "") {
        $.ajax({
            ...
            data: {
                "_token": "Is4spYF85lADGKJFxZd6A09hXitR8VBAopKLhESO",
                "id": vl
            },
...
function checksseyword() {
    var checkeyword = $('#checkeyword').val().length;
    var count = 5000 - checkeyword;
    var cor = checkeyword + '/' + count;
    $('.countype').html(cor);
