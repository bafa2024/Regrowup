...
<head>
    ...
    <link rel="shortcut icon" href="http://itsugestion.com/dev/workhouse/assets/images/f-icon.png" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css" />
    <link rel="stylesheet" href="http://itsugestion.com/dev/workhouse/assets/css/custom-style.css" type="text/css" />
    <link rel="stylesheet" href="http://itsugestion.com/dev/workhouse/assets/sass/main.css" type="text/css" />
    <link rel="stylesheet" href="http://itsugestion.com/dev/workhouse/assets/sass/otherstyle.css" type="text/css" />
    <link rel="stylesheet" href="http://itsugestion.com/dev/workhouse/assets/css/virtual-select.min.css" type="text/css" />
</head>
        ...
        <div class="main-nav d-block">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-lg">
                    <a class="navbar-brand w-120 w-md-140 fulw" href="http://itsugestion.com/dev/workhouse/home">
                        <img src="http://itsugestion.com/dev/workhouse/assets/images/logo.png" alt="logo" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/home">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/jobs/Employment">Employment</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/jobs/Freelancer">Freelancers</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/browsegigs"
                                    onclick="return offertype('Gigs')">Gigs</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/coursesection"
                                    onclick="return offertype('coursesection')">Education</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/jobs/Localjobs">Local Jobs</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://itsugestion.com/dev/workhouse/chat">messages</a>
                            </li>
                        </ul>
                        <div class="d-flex align-items-center gap-1 justify-content-end pe-3 pe-md-0">
                            <div class="top-search-box">
                                <button type="button" id="serBtn">
                                    <i class="fal fa-search" aria-hidden="true"></i>
                                </button>
                                <div class="iner-box-search" style="display: none">
                                    <form action="http://itsugestion.com/dev/workhouse/searchjobs" method="get">
                                        <input type="hidden" name="_token" value="I9Y0GWpiU9y6LB8j48wxwFKDZeO5041uwSxyYByW">                                        <div class="d-flex">
                                            <div class="flex">
                            ...
                            <div class="bell-noti rel">
                                <button type="button" class="rel" id="noti-box">
                                    <img src="http://itsugestion.com/dev/workhouse/assets/images/bell.png" alt="bell" />
                                </button>
                            ...
                            <div class="user-pic rel w-120">
                                <button type="button" id="user-log" class="d-flex gap-3 align-items-center w-100">
                                    <div class="user-pic w-30 h-30 rounded-circle overflow-hidden ofit flex-shrink-0">
                                                                                <img src="http://itsugestion.com/dev/workhouse/assets/images/user.png" alt="logo" />
                                        
                                    </div>
                                    <span class="fs-14 text-black flex-grow">Alex</span>
                                </button>
                                <div class="user-log-box">
                                    <div class=" d-flex flex-column">

                                        <a href="http://itsugestion.com/dev/workhouse/createpost"><i class="fal fa-address-card"></i>
                                            Profile</a>

                                        <!--   <a href="http://itsugestion.com/dev/workhouse/createpost"><i class="fal fa-address-card"></i> Post a
                                            request</a> -->
                                        <a href="http://itsugestion.com/dev/workhouse/createblog"><i class="fab fa-blogger-b mt-2"></i> Post a
                                            Blog</a>
                                        <a href="http://itsugestion.com/dev/workhouse/searchjobs"><i class="fab fa-blogger-b mt-2"></i> Jobs</a>
                                        <a href="http://itsugestion.com/dev/workhouse/viewblog"><i class="fas fa-eye mt-2"></i> View Blog</a>
                                        <a href="http://itsugestion.com/dev/workhouse/cvpage"><i class="fas fa-eye mt-2"></i> Create CV
                                            Form</a>
                                        <a href="http://itsugestion.com/dev/workhouse/logout"><i class="fas fa-sign-out-alt mt-2"></i> Log
                                            out</a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row gy-4">
            <div class="col-12">
                <div class="d-block bg-white p-3 p-md-5 bg-white rounded-3 shadow">
                    ...
                    <form method="POST" action="http://itsugestion.com/dev/workhouse/gigs/savepost" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="I9Y0GWpiU9y6LB8j48wxwFKDZeO5041uwSxyYByW">                        <div class="row gy-4">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <select name="category" id="category" required
                                        ...
                                        <option value="">Select</option>
                                                                                                                        <option value="16">Local Jobs</option>
                                                                                <option value="15">Writing</option>
                                                                                <option value="14">Web, Mobile &amp; Software Dev</option>
                                                                                <option value="13">Translation</option>
                                                                                <option value="12">Sales &amp; Marketing</option>
                                                                                <option value="11">Legal</option>
                                                                                <option value="10">IT &amp; Networking</option>
                                                                                <option value="9">Engineering &amp; Architecture</option>
                                                                                <option value="8">Design &amp; Creative</option>
                                                                                <option value="7">Data Science &amp; Analytics</option>
                                                                                <option value="6">Customer Service</option>
                                                                                <option value="5">Admin Support</option>
                                                                                <option value="1">Accounting &amp; Consulting</option>
                                                                                                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 step1">
                                <div class="d-flex flex-column gap-2 addsubcat">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <select name="location" id="" required
                                        ...
                                        <option value="">Select Location</option>
                                                                                ...
                                                                                <option value="Aberaman">Aberaman</option>
                                                                                <option value="Aberbargoed">Aberbargoed</option>
                                                                                ...
                                                                                <option value="Abersychan">Abersychan</option>
                                                                                ...
                                                                                <option value="Allestree">Allestree</option>
                                                                                <option value="Allington">Allington</option>
                                                                                <option value="Alloa">Alloa</option>
                                                                                <option value="Almondbury">Almondbury</option>
                                                                                ...
                                                                                <option value="Altofts">Altofts</option>
                                                                                ...
                                                                                <option value="Aughton">Aughton</option>
                                                                                ...
                                                                                <option value="Balderton">Balderton</option>
                                                                                ...
                                                                                <option value="Bamber Bridge">Bamber Bridge</option>
                                                                                ...
                                                                                <option value="Barton upon Irwell">Barton upon Irwell</option>
                                                                                <option value="Barton-le-Clay">Barton-le-Clay</option>
                                                                                <option value="Barwell">Barwell</option>
                                                                                ...
                                                                                <option value="Batheaston">Batheaston</option>
                                                                                ...
                                                                                <option value="Baystonhill">Baystonhill</option>
                                                                                ...
                                                                                <option value="Berkhampstead">Berkhampstead</option>
                                                                                ...
                                                                                <option value="Biddenden">Biddenden</option>
                                                                                ...
                                                                                <option value="Bidston">Bidston</option>
                                                                                ...
                                                                                <option value="Bilton">Bilton</option>
                                                                                <option value="Bilton">Bilton</option>
                                                                                ...
                                                                                <option value="Blaina">Blaina</option>
                                                                                ...
                                                                                <option value="Blofield">Blofield</option>
                                                                                <option value="Bloxham">Bloxham</option>
                                                                                <option value="Bloxwich">Bloxwich</option>
                                                                                <option value="Blundellsands">Blundellsands</option>
                                                                                <option value="Blunsdon Saint Andrew">Blunsdon Saint Andrew</option>
                                                                                <option value="Blyth">Blyth</option>
                                                                                <option value="Blythebridge">Blythebridge</option>
                                                                                ...
                                                                                <option value="Bottesford">Bottesford</option>
                                                                                <option value="Boughton Monchelsea">Boughton Monchelsea</option>
                                                                                <option value="Boultham">Boultham</option>
                                                                                ...
                                                                                <option value="Boxley">Boxley</option>
                                                                                ...
                                                                                <option value="Branston">Branston</option>
                                                                                <option value="Branston">Branston</option>
                                                                                <option value="Braunstone">Braunstone</option>
                                                                                <option value="Braunton">Braunton</option>
                                                                                <option value="Bray">Bray</option>
                                                                                <option value="Brayton">Brayton</option>
                                                                                <option value="Breage">Breage</option>
                                                                                ...
                                                                                <option value="Brenchley">Brenchley</option>
                                                                                ...
                                                                                <option value="Brimington">Brimington</option>
                                                                                ...
                                                                                <option value="Brockworth">Brockworth</option>
                                                                                <option value="Brodsworth">Brodsworth</option>
                                                                                ...
                                                                                <option value="Brotton">Brotton</option>
                                                                                ...
                                                                                <option value="Brynna">Brynna</option>
                                                                                ...
                                                                                <option value="Bucksburn">Bucksburn</option>
                                                                                ...
                                                                                <option value="Burghfield">Burghfield</option>
                                                                                ...
                                                                                <option value="Bushbury">Bushbury</option>
                                                                                <option value="Bushey">Bushey</option>
                                                                                <option value="Buxted">Buxted</option>
                                                                                ...
                                                                                <option value="Carfin">Carfin</option>
                                                                                <option value="Carisbrooke">Carisbrooke</option>
                                                                                ...
                                                                                <option value="Carron">Carron</option>
                                                                                ...
                                                                                <option value="Chaddesden">Chaddesden</option>
                                                                                <option value="Chailey">Chailey</option>
                                                                                <option value="Chalfont Saint Giles">Chalfont Saint Giles</option>
                                                                                ...
                                                                                <option value="Chestfield">Chestfield</option>
                                                                                <option value="Chichester">Chichester</option>
                                                                                <option value="Chickerell">Chickerell</option>
                                                                                <option value="Chiddingfold">Chiddingfold</option>
                                                                                <option value="Chieveley">Chieveley</option>
                                                                                <option value="Chigwell">Chigwell</option>
                                                                                <option value="Childwall">Childwall</option>
                                                                                <option value="Chilwell">Chilwell</option>
                                                                                ...
                                                                                <option value="Clanfield">Clanfield</option>
                                                                                ...
                                                                                <option value="Clipstone">Clipstone</option>
                                                                                ...
                                                                                <option value="Colney Heath">Colney Heath</option>
                                                                                ...
                                                                                <option value="Connahs Quay">Connahs Quay</option>
                                                                                ...
                                                                                <option value="Corfe Mullen">Corfe Mullen</option>
                                                                                ...
                                                                                <option value="Coundon">Coundon</option>
                                                                                ...
                                                                                <option value="Cowley">Cowley</option>
                                                                                <option value="Cowpen">Cowpen</option>
                                                                                ...
                                                                                <option value="Cumnor">Cumnor</option>
                                                                                ...
                                                                                <option value="Cymmer">Cymmer</option>
                                                                                ...
                                                                                <option value="Davenham">Davenham</option>
                                                                                ...
                                                                                <option value="Deeping Saint James">Deeping Saint James</option>
                                                                                ...
                                                                                <option value="Deysbrook">Deysbrook</option>
                                                                                ...
                                                                                <option value="Dorridge">Dorridge</option>
                                                                                <option value="Dover">Dover</option>
                                                                                <option value="Dowlais">Dowlais</option>
                                                                                ...
                                                                                <option value="Draycott">Draycott</option>
                                                                                ...
                                                                                <option value="Earlestown">Earlestown</option>
                                                                                ...
                                                                                <option value="Earlswood">Earlswood</option>
                                                                                ...
                                                                                <option value="East Woodhay">East Woodhay</option>
                                                                                <option value="Eastbourne">Eastbourne</option>
                                                                                <option value="Eastchurch">Eastchurch</option>
                                                                                <option value="Eastergate">Eastergate</option>
                                                                                ...
                                                                                <option value="Edwalton">Edwalton</option>
                                                                                <option value="Edwinstowe">Edwinstowe</option>
                                                                                <option value="Effingham">Effingham</option>
                                                                                <option value="Egg Buckland">Egg Buckland</option>
                                                                                ...
                                                                                <option value="Elsecar">Elsecar</option>
                                                                                ...
                                                                                <option value="Englefield Green">Englefield Green</option>
                                                                                ...
                                                                                <option value="Eythorne">Eythorne</option>
                                                                                ...
                                                                                <option value="Farington">Farington</option>
                                                                                ...
                                                                                <option value="Fazakerley">Fazakerley</option>
                                                                                ...
                                                                                <option value="Felpham">Felpham</option>
                                                                                <option value="Felsted">Felsted</option>
                                                                                <option value="Feltham">Feltham</option>
                                                                                <option value="Felton">Felton</option>
                                                                                <option value="Feltwell">Feltwell</option>
                                                                                <option value="Fen Stanton">Fen Stanton</option>
                                                                                <option value="Fenton">Fenton</option>
                                                                                <option value="Feock">Feock</option>
                                                                                <option value="Fern Down">Fern Down</option>
                                                                                ...
                                                                                <option value="Fishtoft">Fishtoft</option>
                                                                                ...
                                                                                <option value="Glascote">Glascote</option>
                                                                                <option value="Glasgow">Glasgow</option>
                                                                                <option value="Glastonbury">Glastonbury</option>
                                                                                <option value="Glemsford">Glemsford</option>
                                                                                <option value="Glen Parva">Glen Parva</option>
                                                                                ...
                                                                                <option value="Glynneath">Glynneath</option>
                                                                                ...
                                                                                <option value="Gornalwood">Gornalwood</option>
                                                                                ...
                                                                                <option value="Gowerton">Gowerton</option>
                                                                                ...
                                                                                <option value="Great Billing">Great Billing</option>
                                                                                <option value="Great Bookham">Great Bookham</option>
                                                                                <option value="Great Burstead">Great Burstead</option>
                                                                                <option value="Great Chart">Great Chart</option>
                                                                                <option value="Great Cornard">Great Cornard</option>
                                                                                <option value="Great Driffield">Great Driffield</option>
                                                                                <option value="Great Dunmow">Great Dunmow</option>
                                                                                <option value="Great Harwood">Great Harwood</option>
                                                                                <option value="Great Linford">Great Linford</option>
                                                                                <option value="Great Meols">Great Meols</option>
                                                                                ...
                                                                                <option value="Great Wakering">Great Wakering</option>
                                                                                <option value="Great Warley Street">Great Warley Street</option>
                                                                                ...
                                                                                <option value="Greetland">Greetland</option>
                                                                                <option value="Grenoside">Grenoside</option>
                                                                                <option value="Gresford">Gresford</option>
                                                                                <option value="Gretna">Gretna</option>
                                                                                <option value="Griffithstown">Griffithstown</option>
                                                                                <option value="Grimsargh">Grimsargh</option>
                                                                                ...
                                                                                <option value="Gwithian">Gwithian</option>
                                                                                ...
                                                                                <option value="Harlescott">Harlescott</option>
                                                                                ...
                                                                                <option value="Harton">Harton</option>
                                                                                ...
                                                                                <option value="Headley">Headley</option>
                                                                                ...
                                                                                <option value="Hellesdon">Hellesdon</option>
                                                                                <option value="Helmshore">Helmshore</option>
                                                                                ...
                                                                                <option value="Hesketh Bank">Hesketh Bank</option>
                                                                                ...
                                                                                <option value="High Ackworth">High Ackworth</option>
                                                                                ...
                                                                                <option value="Hilperton">Hilperton</option>
                                                                                ...
                                                                                <option value="Hipperholme">Hipperholme</option>
                                                                                ...
                                                                                <option value="Holme upon Spalding Moor">Holme upon Spalding Moor</option>
                                                                                <option value="Holmes Chapel">Holmes Chapel</option>
                                                                                <option value="Holmewood">Holmewood</option>
                                                                                ...
                                                                                <option value="Hordle">Hordle</option>
                                                                                ...
                                                                                <option value="Horsehay">Horsehay</option>
                                                                                <option value="Horsell">Horsell</option>
                                                                                ...
                                                                                <option value="Hucknall under Huthwaite">Hucknall under Huthwaite</option>
                                                                                ...
                                                                                <option value="Icklesham">Icklesham</option>
                                                                                <option value="Ifield">Ifield</option>
                                                                                ...
                                                                                <option value="Illogan">Illogan</option>
                                                                                ...
                                                                                <option value="Iwade">Iwade</option>
                                                                                ...
                                                                                <option value="Kew Green">Kew Green</option>
                                                                                ...
                                                                                <option value="Kilnhurst">Kilnhurst</option>
                                                                                ...
                                                                                <option value="Kings Norton">Kings Norton</option>
                                                                                ...
                                                                                <option value="Kirkby Moorside">Kirkby Moorside</option>
                                                                                ...
                                                                                <option value="Kirkleatham">Kirkleatham</option>
                                                                                ...
                                                                                <option value="Lea Town">Lea Town</option>
                                                                                <option value="Leagrave">Leagrave</option>
                                                                                <option value="Leatherhead">Leatherhead</option>
                                                                                <option value="Leavesden Green">Leavesden Green</option>
                                                                                ...
                                                                                <option value="Leverington">Leverington</option>
                                                                                ...
                                                                                <option value="Limpsfield">Limpsfield</option>
                                                                                ...
                                                                                <option value="Linslade">Linslade</option>
                                                                                ...
                                                                                <option value="Little Plumstead">Little Plumstead</option>
                                                                                <option value="Littleborough">Littleborough</option>
                                                                                <option value="Littlehampton">Littlehampton</option>
                                                                                <option value="Littlemore">Littlemore</option>
                                                                                ...
                                                                                <option value="Llanasa">Llanasa</option>
                                                                                <option value="Llanbadarn-fawr">Llanbadarn-fawr</option>
                                                                                <option value="Llanbradach">Llanbradach</option>
                                                                                <option value="Llandow">Llandow</option>
                                                                                ...
                                                                                <option value="Llangendeirne">Llangendeirne</option>
                                                                                ...
                                                                                <option value="Llantarnam">Llantarnam</option>
                                                                                ...
                                                                                <option value="Long Ditton">Long Ditton</option>
                                                                                ...
                                                                                <option value="Long Stanton">Long Stanton</option>
                                                                                ...
                                                                                <option value="Loudwater">Loudwater</option>
                                                                                <option value="Loughborough">Loughborough</option>
                                                                                <option value="Loughor">Loughor</option>
                                                                                <option value="Loughton">Loughton</option>
                                                                                <option value="Louth">Louth</option>
                                                                                <option value="Lowdham">Lowdham</option>
                                                                                <option value="Lower Kingswood">Lower Kingswood</option>
                                                                                ...
                                                                                <option value="Lydiate">Lydiate</option>
                                                                                ...
                                                                                <option value="Margam">Margam</option>
                                                                                ...
                                                                                <option value="Middleton-on-Sea">Middleton-on-Sea</option>
                                                                                ...
                                                                                <option value="Mosbrough">Mosbrough</option>
                                                                                ...
                                                                                <option value="Moulton">Moulton</option>
                                                                                <option value="Moulton Chapel">Moulton Chapel</option>
                                                                                ...
                                                                                <option value="Murston">Murston</option>
                                                                                <option value="Musselburgh">Musselburgh</option>
                                                                                <option value="Muxton">Muxton</option>
                                                                                <option value="Mytchett">Mytchett</option>
                                                                                ...
                                                                                <option value="Nantyglo">Nantyglo</option>
                                                                                ...
                                                                                <option value="New Buildings">New Buildings</option>
                                                                                <option value="New Cumnock">New Cumnock</option>
                                                                                <option value="New Earswick">New Earswick</option>
                                                                                ...
                                                                                <option value="New Scone">New Scone</option>
                                                                                ...
                                                                                <option value="Newhouse">Newhouse</option>
                                                                                <option value="Newington">Newington</option>
                                                                                <option value="Newlyn">Newlyn</option>
                                                                                <option value="Newmacher">Newmacher</option>
                                                                                ...
                                                                                <option value="Newton Grange">Newton Grange</option>
                                                                                <option value="Newton in Makerfield">Newton in Makerfield</option>
                                                                                ...
                                                                                <option value="North Collingham">North Collingham</option>
                                                                                <option value="North Elmsall">North Elmsall</option>
                                                                                <option value="North Ferriby">North Ferriby</option>
                                                                                <option value="North Hinksey">North Hinksey</option>
                                                                                ...
                                                                                <option value="North Tidworth">North Tidworth</option>
                                                                                ...
                                                                                <option value="Northchurch">Northchurch</option>
                                                                                ...
                                                                                <option value="Old Brampton">Old Brampton</option>
                                                                                ...
                                                                                <option value="Parkgate">Parkgate</option>
                                                                                ...
                                                                                <option value="Pen-y-cae">Pen-y-cae</option>
                                                                                <option value="Penarth">Penarth</option>
                                                                                <option value="Penclawdd">Penclawdd</option>
                                                                                ...
                                                                                <option value="Penmaenmawr">Penmaenmawr</option>
                                                                                ...
                                                                                <option value="Perranzabuloe">Perranzabuloe</option>
                                                                                <option value="Perry Barr">Perry Barr</option>
                                                                                <option value="Pershore">Pershore</option>
                                                                                <option value="Perth">Perth</option>
                                                                                <option value="Peterculter">Peterculter</option>
                                                                                ...
                                                                                <option value="Pont-y-pŵl">Pont-y-pŵl</option>
                                                                                <option value="Pontardawe">Pontardawe</option>
                                                                                <option value="Pontardulais">Pontardulais</option>
                                                                                ...
                                                                                <option value="Presteign">Presteign</option>
                                                                                ...
                                                                                <option value="Pyrford">Pyrford</option>
                                                                                <option value="Quarrington">Quarrington</option>
                                                                                ...
                                                                                <option value="Rainhill">Rainhill</option>
                                                                                <option value="Rainow">Rainow</option>
                                                                                ...
                                                                                <option value="Rhôs-on-Sea">Rhôs-on-Sea</option>
                                                                                ...
                                                                                <option value="Rotherfield">Rotherfield</option>
                                                                                ...
                                                                                <option value="Ryhope">Ryhope</option>
                                                                                ...
                                                                                <option value="Saint Athan">Saint Athan</option>
                                                                                <option value="Saint Austell">Saint Austell</option>
                                                                                <option value="Saint Blazey">Saint Blazey</option>
                                                                                <option value="Saint Budeaux">Saint Budeaux</option>
                                                                                ...
                                                                                <option value="Saint Ives">Saint Ives</option>
                                                                                <option value="Saint Margaret’s at Cliffe">Saint Margaret’s at Cliffe</option>
                                                                                ...
                                                                                <option value="Sandridge">Sandridge</option>
                                                                                <option value="Sandwich">Sandwich</option>
                                                                                <option value="Sandy">Sandy</option>
                                                                                <option value="Sandycroft">Sandycroft</option>
                                                                                <option value="Sauchie">Sauchie</option>
                                                                                ...
                                                                                <option value="Sawley">Sawley</option>
                                                                                ...
                                                                                <option value="Scarisbrick">Scarisbrick</option>
                                                                                <option value="Scartho">Scartho</option>
                                                                                <option value="Scotter">Scotter</option>
                                                                                <option value="Scunthorpe">Scunthorpe</option>
                                                                                <option value="Seacombe">Seacombe</option>
                                                                                <option value="Seacroft">Seacroft</option>
                                                                                ...
                                                                                <option value="Seasalter">Seasalter</option>
                                                                                <option value="Seaton">Seaton</option>
                                                                                <option value="Seaton Carew">Seaton Carew</option>
                                                                                ...
                                                                                <option value="Sherborne Saint John">Sherborne Saint John</option>
                                                                                <option value="Sherburn in Elmet">Sherburn in Elmet</option>
                                                                                <option value="Sheriff Hill">Sheriff Hill</option>
                                                                                ...
                                                                                <option value="Shotley Bridge">Shotley Bridge</option>
                                                                                ...
                                                                                <option value="Skellow">Skellow</option>
                                                                                ...
                                                                                <option value="Skewen">Skewen</option>
                                                                                ...
                                                                                <option value="South Hanningfield">South Hanningfield</option>
                                                                                ...
                                                                                <option value="Speldhurst">Speldhurst</option>
                                                                                ...
                                                                                <option value="Stainland">Stainland</option>
                                                                                ...
                                                                                <option value="Steynton">Steynton</option>
                                                                                ...
                                                                                <option value="Stoke Mandeville">Stoke Mandeville</option>
                                                                                ...
                                                                                <option value="Stonehouse">Stonehouse</option>
                                                                                <option value="Stoneleigh">Stoneleigh</option>
                                                                                ...
                                                                                <option value="Stopsley">Stopsley</option>
                                                                                ...
                                                                                <option value="Stratton Saint Margaret">Stratton Saint Margaret</option>
                                                                                ...
                                                                                <option value="Sundon">Sundon</option>
                                                                                ...
                                                                                <option value="Sutton on Hull">Sutton on Hull</option>
                                                                                ...
                                                                                <option value="Swallownest">Swallownest</option>
                                                                                <option value="Swalwell">Swalwell</option>
                                                                                <option value="Swanage">Swanage</option>
                                                                                <option value="Swanland">Swanland</option>
                                                                                ...
                                                                                <option value="Swinton">Swinton</option>
                                                                                <option value="Swynnerton">Swynnerton</option>
                                                                                ...
                                                                                <option value="Terrington Saint Clement">Terrington Saint Clement</option>
                                                                                <option value="Tetbury">Tetbury</option>
                                                                                <option value="Tettenhall">Tettenhall</option>
                                                                                ...
                                                                                <option value="Thatto Heath">Thatto Heath</option>
                                                                                <option value="Thaxted">Thaxted</option>
                                                                                <option value="The Mumbles">The Mumbles</option>
                                                                                ...
                                                                                <option value="Thorpe Saint Andrew">Thorpe Saint Andrew</option>
                                                                                <option value="Thrapston">Thrapston</option>
                                                                                <option value="Thringstone">Thringstone</option>
                                                                                <option value="Thrybergh">Thrybergh</option>
                                                                                ...
                                                                                <option value="Ticehurst">Ticehurst</option>
                                                                                <option value="Tickhill">Tickhill</option>
                                                                                <option value="Tidenham">Tidenham</option>
                                                                                ...
                                                                                <option value="Titchfield">Titchfield</option>
                                                                                ...
                                                                                <option value="Torrisholme">Torrisholme</option>
                                                                                ...
                                                                                <option value="Upholland">Upholland</option>
                                                                                <option value="Upminster">Upminster</option>
                                                                                <option value="Upper Beeding">Upper Beeding</option>
                                                                                ...
                                                                                <option value="Wadsley">Wadsley</option>
                                                                                ...
                                                                                <option value="Walsall Wood">Walsall Wood</option>
                                                                                ...
                                                                                <option value="Walton le Dale">Walton le Dale</option>
                                                                                ...
                                                                                <option value="Warmsworth">Warmsworth</option>
                                                                                ...
                                                                                <option value="Washingborough">Washingborough</option>
                                                                                ...
                                                                                <option value="Weedon Beck">Weedon Beck</option>
                                                                                <option value="Wellesbourne Hastings">Wellesbourne Hastings</option>
                                                                                ...
                                                                                <option value="Wembdon">Wembdon</option>
                                                                                ...
                                                                                <option value="West Boldon">West Boldon</option>
                                                                                ...
                                                                                <option value="West Chiltington">West Chiltington</option>
                                                                                <option value="West Coker">West Coker</option>
                                                                                ...
                                                                                <option value="West Monkton">West Monkton</option>
                                                                                <option value="West Parley">West Parley</option>
                                                                                ...
                                                                                <option value="Wibsey">Wibsey</option>
                                                                                <option value="Wick">Wick</option>
                                                                                <option value="Wickersley">Wickersley</option>
                                                                                ...
                                                                                <option value="Willesborough">Willesborough</option>
                                                                                ...
                                                                                <option value="Wilnecote">Wilnecote</option>
                                                                                <option value="Wilpshire">Wilpshire</option>
                                                                                ...
                                                                                <option value="Winchcomb">Winchcomb</option>
                                                                                ...
                                                                                <option value="Winkfield">Winkfield</option>
                                                                                ...
                                                                                <option value="Wisbech Saint Mary">Wisbech Saint Mary</option>
                                                                                ...
                                                                                <option value="Withnell">Withnell</option>
                                                                                <option value="Withyham">Withyham</option>
                                                                                ...
                                                                                <option value="Wombourn">Wombourn</option>
                                                                                <option value="Wombwell">Wombwell</option>
                                                                                <option value="Wonersh">Wonersh</option>
                                                                                <option value="Wooburn">Wooburn</option>
                                                                                ...
                                                                                <option value="Woodlesford">Woodlesford</option>
                                                                                ...
                                                                                <option value="Wordsley">Wordsley</option>
                                                                                ...
                                                                                <option value="Worsborough">Worsborough</option>
                                                                                ...
                                                                                <option value="Wraysbury">Wraysbury</option>
                                                                                <option value="Wrecclesham">Wrecclesham</option>
                                                                                <option value="Wrecsam">Wrecsam</option>
                                                                                <option value="Wrington">Wrington</option>
                                                                                <option value="Writtle">Writtle</option>
                                                                                <option value="Wrockwardine">Wrockwardine</option>
                                                                                <option value="Wroughton">Wroughton</option>
                                                                                <option value="Wyberton">Wyberton</option>
                                                                                <option value="Wyke">Wyke</option>
                                                                                <option value="Wyke Regis">Wyke Regis</option>
                                                                                ...
                                                                                <option value="Ynysddu">Ynysddu</option>
                            ...
                            <div class="col-12 step1">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" onclick="return formstep1()"
                                        class="formstep1 viewmore-btn border-0"> Next</button>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <ol class="d-flex flex-column gap-2 ps-2 appendfaq">
                                        <li class="">
                                            ...
                                            <textarea name="ans[]" required id="" cols="30" rows="4"
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        <button type="button" class="viewmore-btn border-0 addfaq"> <i
                                                class="fal fa-plus"></i>
                                            Add More</button>
                                    </div>
                                </div>
                            ...
                            <div class=" justify-content-end gap-2 step2">
                                <button type="submit" class="viewmore-btn border-0 formstep2"
                                    onclick="return formstep2()">
                                    Next</button>
                            </div>
                                    ...
                                    <div class="row row-cols-2 row-cols-md-5 addmorevideo">
                                        <div class="col">
                                            <div
                                                ...
                                                <input type="file" name="file[]" id="" class="file-upload">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 step3">
                                        <div class="d-flex justify-content-end">
                                            <button type="button" class="submi-btn border-0 addvideos"> <i
                                                    class="fal fa-plus"></i>
                                                Add More</button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 step3">
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="submi-btn border-0">
                                        Publish gig</button>
                                </div>
                            </div>
                        </div>
...
<footer>
    <div class="footer-top d-block py-60">
        <div class="container-lg">
            <div class="row gy-4">
                <div class="col-md-3">
                    <div class="d-flex flex-column gap-3">
                        <a href="#" class="w-170 d-block fulw">
                            <img src="http://itsugestion.com/dev/workhouse/assets/images/logo-white.png" alt="logo" />
                        </a>
                        <p class="fs-13 text-white">
                            Unlock your career potential with The Workhouse - revolutionizing recruitment for a brighter
                            future. Experience seamless job searching and hiring, as we connect skilled professionals
                            with exceptional employers.
                        </p>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="d-flex flex-column gap-3">
                                <h3 class="text-whitie fs-15 fw-800 text-white text-uppercase">
                                    For Contracters
                                </h3>
                                <div class="d-flex flex-column gap-2">
                                    <a href="#" class="text-white fs-13">How to find jobs</a>
                                    <a href="#" class="text-white fs-13">How courses works</a>
                                    <a href="#" class="text-white fs-13">What are mini jobs</a>
                                    <a href="#" class="text-white fs-13">Setting Projects</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <a href="#" class="text-white fs-13">How to hire</a>
                                    <a href="#" class="text-white fs-13">Buy a course</a>
                                    <a href="#" class="text-white fs-13">Project catalog</a>
                                    <a href="#" class="text-white fs-13">Eliite membership</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <a href="#" class="text-white fs-13">Careers</a>
                                    <a href="#" class="text-white fs-13">FAQs</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <!--<a href="tel:1800000000" class="d-flex gap-3">
                                         <div class="shrink">
                                            <i
                                                class="fas fa-phone-alt bg-white rounded-1 text-center mytext-secondary w-40 h-40 pt-13"></i>
                                        </div>
                                        <div class="grow">
                                            <div class="d-flex flex-column">
                                                <h6 class="text-white fw-600 fs-13">Support</h6>
                                                 <p class="text-white fw-400 fs-13">+1800 00000</p> 
                                            </div>
                                        </div> 
                                     </a> 
                                 -->
                                    <button type="submit" class="clear-btn float-md-end" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal">
                                        Support
                                    </button>

                                    <a href="mailto:customerservice@theworkhouse.io" class="d-flex gap-3">
                                        <div class="shrink">
                                            <i class="fas fa-envelope bg-white rounded-1 text-center mytext-secondary w-40 h-40 pt-13"
                                                aria-hidden="true"></i>
                                        </div>
                                        <div class="grow">
                                            <div class="d-flex flex-column">
                                                <h6 class="text-white fw-600 fs-13">Email:</h6>
                                                <p class="text-white fw-400 fs-13">customerservice@theworkhouse.io</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
    ...
    <div class="copyright bg-white py-2">
        <div class="container-lg">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="d-flex gap-2">

                        <a href="https://www.instagram.com/theworkhouse15/" target="_blank" class="s-icon"><i
                                class="fab fa-instagram"></i></a>
                        <a href="https://twitter.com/theworkhouse2" target="_blank" class="s-icon"><i
                                class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/the-workhouse-649242253" target="_blank" class="s-icon"><i
                                class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <p class="text-black fs-12 text-center">© Copyrights 2023. All Rights Reserved.</p>
                </div>
                <div class="col-md-4">
                    <a href="#" class="text-black fs-12 text-center float-none float-md-end">Terms and Conditions.</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="javascript:void(0)">
                    <input type="hidden" name="_token" value="I9Y0GWpiU9y6LB8j48wxwFKDZeO5041uwSxyYByW">                    <div class="row gy-3">
                        <div class="col-12">
                            <div class="d-flex flex-column gap-2">
...
function sendmail() {
    ...
    if (email != "") {
        $('.supportsbm').html('Please wait...');
        $.ajax({
            type: "post",
            dataType: "json",
            async: false,
            url: "http://itsugestion.com/dev/workhouse/home/sendmail",
            data: {
