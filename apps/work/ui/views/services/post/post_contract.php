                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-6" id="hours_per_week">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <input type="number" name="week_hours" id="week_hours"  class="bg-white w-100 border border-secondary border-opacity-25 p-2 fs-14 rounded-2" />
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="d-flex flex-column gap-2">
...
<script>
    ...
    const hoursPerWeekField = document.getElementById("hours_per_week");

    // Event listener for radio button change
    fixedRadio.addEventListener("change", updateFields);
    hourlyRadio.addEventListener("change", updateFields);

    // Function to update the fields based on the selected radio button
    function updateFields() {
        if (hourlyRadio.checked) {
            priceInput.placeholder = "Type hourly rate.....";
            hoursPerWeekField.style.display = "block";
        } else {
            priceInput.placeholder = "Type here.....";
